# ZLDA-FILE FILE WITH FORCE JOIN
...
### Installation
#### Deploy on Heroku
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/nmiabdfhmy/Zelda-File-3)</br>
...
#### Deploy in your VPS
````bash
git clone https://github.com/nmiabdfhmy/Zelda-File-3
cd Zelda-File-3
...
[ZLDAFile](https://github.com/nmiabdfhmy/ZLDAFile-TripleB) is Free Software: You can use, study share and improve it at your
