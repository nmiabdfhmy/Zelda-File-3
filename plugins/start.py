...
from bot import Bot
from config import ADMINS, CUSTOM_CAPTION, DISABLE_CHANNEL_BUTTON, FORCE_MSG, START_MSG, FORCE_SUB_CHANNEL, CHANNEL_ID, BTN_1, BTN_2, BTN_3
...
async def start_command(client: Client, message: Message):
    ...
    if len(text) > 7:
        ...
        buttons = [
            ...
            [
                InlineKeyboardButton(f"{BTN_1}", url=client.invitelink),
            ],
            [
                InlineKeyboardButton(f"{BTN_2}", url=client.invitelink2),
                InlineKeyboardButton(f"{BTN_3}", url=client.invitelink3),
            ],
